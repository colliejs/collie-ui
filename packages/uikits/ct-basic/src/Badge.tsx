  ...
  variants: {
    ...
    variant: {
      ...
      pink: {
        ...
        "&:focus": {
          boxShadow:
            "inset 0 0 0 1px $colors$pink8, 0 0 0 1px $colors$pink8",
        },
      },
      purple: {
      ...
      cyan: {
        ...
        "&:focus": {
          boxShadow:
            "inset 0 0 0 1px $colors$cyan8, 0 0 0 1px $colors$cyan8",
        },
      },
      teal: {
        ...
        "&:focus": {
          boxShadow:
            "inset 0 0 0 1px $colors$teal8, 0 0 0 1px $colors$teal8",
        },
      },
      green: {
      ...
      lime: {
        ...
        "&:focus": {
          boxShadow:
            "inset 0 0 0 1px $colors$lime8, 0 0 0 1px $colors$lime8",
        },
      },
      yellow: {
      ...
      gold: {
        ...
        "&:focus": {
          boxShadow:
            "inset 0 0 0 1px $colors$gold8, 0 0 0 1px $colors$gold8",
        },
      },
      bronze: {
